      ...
      >
        <Box>
          ...
          <Typography variant="body2" align="left" paddingTop={1}>
            ...
            outline your rights as an adult participant participating in an
            in-lab/in-person research study. Please read the remainder of this
            form in its entirety and address any questions that you may have to
            the Lead Researcher or Lab Coordinator prior to indicating your
            consent and before participating.
          </Typography>
          <Typography variant="subtitle1" align="left" paddingTop={2}>
          ...
          <Typography variant="body2" align="left" paddingTop={1}>
            ...
            refer to the study listing provided at sign-up or your email
            confirmation for additional information regarding location and
            parking.
          </Typography>
          <Typography variant="body2" align="left" paddingTop={1}>
          ...
          <Typography variant="body2" align="left" paddingTop={1}>
            ...
            gender, race, and ethnicity, this information is not required in
            order to participate.
          </Typography>
          <Typography variant="body2" align="left" paddingTop={1}>
            • You may be presented with visual information and/or auditory
            information such as speech, sounds, tones, musical notes, words,
            numbers, names, shapes, objects, pictures and/or colors and asked to
            visualize, remember and recall items using your voice or nonverbal
            equivalent (i.e., head nod or thumbs up; head shake or thumbs down),
            a pointing gesture, a keyboard press, a button press, touch screen,
            trackpad, touchpad, or mouse click. Please be aware that visual
            items can flash or appear and disappear very quickly and that sounds
          ...
          <Typography variant="body2" align="left" paddingTop={1}>
            ...
            Researcher (Hamid Nourbakhshi at hnth5@missouri.edu ) or on the
            study listing OR you may contact the MU Working Memory Lab
            Coordinator, Bret Glass, on behalf of Nelson Cowan, Ph.D., Principal
            Investigator and Project Director, via email at glassb@missouri.edu
            (preferred method) or via phone at 573-882-7417.
          </Typography>
          <Typography variant="body2" align="left" paddingTop={1}>
          ...
          <Typography variant="body2" align="left" paddingTop={1}>
            ...
            depending on the Researcher's assigned study area, be able to
            navigate up or down a short flight of stairs.
          </Typography>
          <Typography variant="body2" align="left" paddingTop={1}>
          ...
          <Typography variant="body2" align="left" paddingTop={1}>
            ...
            in the study listing at sign up, and/or you will be informed by the
          ...
          <Typography variant="body2" align="left" paddingTop={1}>
            ...
            specific study, it will be indicated in the study listing provided
            at sign up and/or you will be informed by the Researcher prior to
            your participation.
          </Typography>
          <Typography variant="body2" align="left" paddingTop={1}>
            • If you do not approve of the applications indicated in the study
            listing, please inform the Researcher prior to your participation to
            ensure these applications are not used. If you approve, these
            records will be retained for seven years after completion of the
            study per MU policy on a secure computer server provided and
            maintained by University of Missouri Information Technology
            accessible ONLY to the Project Director and Research Staff. Video
            and/or audio recordings will be expunged after the seven-year
            retention period.
          </Typography>
          <Typography variant="body2" align="left" paddingTop={1}>
            ...
            engagement in the task. $20.00 per hour of participation with an
            additional $5.00 for every 15 minutes after the hour. Payment will
            be provided immediately following participation and after completion
            of a payment form.
          </Typography>
          <Typography variant="subtitle1" align="left" paddingTop={3}>
          ...
          <Typography variant="body2" align="left" paddingTop={1}>
            The amount of compensation will be prorated (equivalent to the TOTAL
          ...
          <Typography variant="subtitle1" align="left" paddingTop={3}>
            • If your participation is canceled or terminated by the Researcher:
          </Typography>
          <Typography variant="body2" align="left" paddingTop={1}>
            ...
            of Illness that prevents you from doing your best. NOTE: The
            condition(s) and the amount of time participated before and up to
            the time of termination may result in reduced or withheld
          ...
          <Typography variant="subtitle1" align="left" paddingTop={3}>
            WHO DO YOU CONTACT IF YOU HAVE QUESTIONS OR CONCERNS NOW, DURING OR
            AFTER?
          </Typography>
          <Typography variant="body2" align="left" paddingTop={1}>
